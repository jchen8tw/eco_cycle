...
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/台灣加權指數1.jpg', dpi=300)
...
def ret(cycle):
    ...
    for i in range(0, len(cycle)):
        x = cycle[i]
        ret1 = (data['TWA00'][x + 200] - data['TWA00'][x]) / data['TWA00'][x]
        ret2 = (data['TWB23'][x + 200] - data['TWB23'][x]) / data['TWB23'][x]
        ret3 = (data['TWB28'][x + 200] - data['TWB28'][x]) / data['TWB28'][x]
        ret4 = (data['TWA06'][x + 200] - data['TWA06'][x]) / data['TWA06'][x]
        ret5 = (data['OTC'][x + 200] - data['OTC'][x]) / data['OTC'][x]
        ret6 = (data['AN'][x + 200] - data['AN'][x]) / data['AN'][x]
...
df_cat.to_csv('/Users/doramaster/Desktop/python/cy_last/drCY/博士長期各階段報酬.csv')
print(df_cat)

step = ['cycle1', 'cycle2', 'cycle3', 'cycle4', 'cycle5', 'cycle6']

plt.figure(2)
plt.plot(cat[0], c = 'turquoise', linewidth = 2, alpha = 1, ls='--', marker='o', mec='r', mfc='r')
x = np.arange(len(cat[0]))
plt.xticks(x, step)
ax2 = plt.gca()
ax2.grid(color='gray', linestyle='--', linewidth=0.8,alpha=0.5)
plt.title('長線-各期台灣加權指數平均報酬')
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-各期台灣加權指數平均報酬.jpg', dpi=300)

plt.figure(3)
plt.plot(cat[1], c = 'turquoise', linewidth = 2, alpha = 1, ls='--', marker='o', mec='r', mfc='r')
x = np.arange(len(cat[1]))
plt.xticks(x, step)
ax3 = plt.gca()
ax3.grid(color='gray', linestyle='--', linewidth=0.8,alpha=0.5)
plt.title('長線-各期電子類指數平均報酬')
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-各期電子類指數平均報酬.jpg', dpi=300)

plt.figure(4)
plt.plot(cat[2], c = 'turquoise', linewidth = 2, alpha = 1, ls='--', marker='o', mec='r', mfc='r')
x = np.arange(len(cat[2]))
plt.xticks(x, step)
ax4 = plt.gca()
ax4.grid(color='gray', linestyle='--', linewidth=1,alpha=0.5)
plt.title('長線-各期金融保險指數平均報酬')
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-各期金融保險指數平均報酬.jpg', dpi=300)

plt.figure(5)
plt.plot(cat[3], c = 'turquoise', linewidth = 2, alpha = 1, ls='--', marker='o', mec='r', mfc='r')
x = np.arange(len(cat[3]))
plt.xticks(x, step)
ax5 = plt.gca()
ax5.grid(color='gray', linestyle='--', linewidth=0.8,alpha=0.5)
plt.title('長線-各期非金電指數平均報酬')
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-各期非金電指數平均報酬.jpg', dpi=300)

plt.figure(6)
plt.plot(cat[4], c = 'turquoise', linewidth = 2, alpha = 1, ls='--', marker='o', mec='r', mfc='r')
x = np.arange(len(cat[4]))
plt.xticks(x, step)
ax6 = plt.gca()
ax6.grid(color='gray', linestyle='--', linewidth=1,alpha=0.5)
plt.title('長線-各期OTC指數平均報酬')
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-各期OTC指數平均報酬.jpg', dpi=300)

plt.figure(7)
plt.plot(cat[5], c = 'turquoise', linewidth = 2, alpha = 1, ls='--', marker='o', mec='r', mfc='r')
x = np.arange(len(cat[5]))
plt.xticks(x, step)
ax7 = plt.gca()
ax7.grid(color='gray', linestyle='--', linewidth=1,alpha=0.5)
plt.title('長線-各期台灣安聯大壩平均報酬')
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-各期台灣安聯大壩平均報酬.jpg', dpi=300)
...
mn = re_cy1
x = np.arange(len(cat))
plt.bar(x, mn, color=['turquoise'],alpha=1)
plt.xticks(x, cat)
plt.ylabel('return(%)')
plt.title('長線-第一階段各指數報酬')

plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-第一階段各指數報酬.jpg', dpi=300)
...
plt.xticks(x, cat)
plt.ylabel('return(%)')
plt.title('長線-第二階段各指數報酬')

plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-第二階段各指數報酬.jpg', dpi=300)
...
plt.xticks(x, cat)
plt.ylabel('return(%)')
plt.title('長線-第三階段各指數報酬')

plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-第三階段各指數報酬.jpg', dpi=300)
...
plt.xticks(x, cat)
plt.ylabel('return(%)')
plt.title('長線-第四階段各指數報酬')

plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-第四階段各指數報酬.jpg', dpi=300)
...
plt.xticks(x, cat)
plt.ylabel('return(%)')
plt.title('長線-第五階段各指數報酬')

plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-第五階段各指數報酬.jpg', dpi=300)
...
plt.xticks(x, cat)
plt.ylabel('return(%)')
plt.title('長線-第六階段各指數報酬')

plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/長線-第六階段各指數報酬.jpg', dpi=300)
...
ax2.grid(color='gray', linestyle='--', linewidth=0.8,alpha=0.5)
plt.legend()
plt.title('長線-全部各期平均報酬')
plt.savefig('/Users/doramaster/Desktop/python/cy_last/drCY/19長線-全部各期平均報酬.jpg', dpi=300)
