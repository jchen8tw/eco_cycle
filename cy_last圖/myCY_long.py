...
data = pd.read_csv('./data/wave89.csv')
...
for i in range( 50, (len(cypi)-1 ) ):
    ...
    if ( cypi[i] != cypi[i+1] and sum(cypi[(i-5):i])/5 == cypi[i] and
            cypi[i+1] == cypi[i+2]):
        ff.extend( [i+1] )
...
plt.savefig('./data/台灣加權指數1.jpg', dpi=300)
...
df_cat.to_csv('./data/自定義長期各階段報酬.csv')
print(df_cat)
...
plt.savefig('./data/長線-各期台灣加權指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-各期電子類指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-各期金融保險指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-各期非金電指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-各期OTC指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-各期台灣安聯大壩平均報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-第一階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-第二階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-第三階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-第四階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-第五階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/長線-第六階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/19長線-全部各期平均報酬.jpg', dpi=300)
