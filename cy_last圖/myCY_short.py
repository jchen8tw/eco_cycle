...
plt.savefig('./data/台灣加權指數.jpg', dpi=300)
...
plt.savefig('./data/短線-第一階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-第二階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-第三階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-第四階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-第五階段各指數報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-第六階段各指數報酬.jpg', dpi=300)
...
df_cat.to_csv('./data/自定義短期各階段報酬.csv')
print(df_cat)
...
plt.savefig('./data/短線-各期台灣加權指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-各期電子類指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-各期金融保險平均報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-各期非金電指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-各期OTC指數平均報酬.jpg', dpi=300)
...
plt.savefig('./data/短線-各期台灣安聯大壩平均報酬.jpg', dpi=300)
...
plt.plot(cat[4], c = 'darkviolet', linewidth = 2, alpha = 0.8, ls='-', marker='o', mec='darkviolet', mfc='darkviolet', label = 'OTC指數')
x = np.arange(len(cat[4]))
plt.xticks(x, step)
...
plt.savefig('./data/19短線-全部各期平均報酬.jpg', dpi=300)
